    ...
    <header class="header">
        <div class="header__container">
            <nav class="header__nav">
                ...
                <a href="#main" class="header__link">Пользователи</a>
                <a href="#main" class="header__link">Роли</a>
                <a href="#main" class="header__link">Машини</a>
                <a href="#main" class="header__link">Классы машин</a>
                <a href="#main" class="header__link">Марки машин</a>
            </nav>
