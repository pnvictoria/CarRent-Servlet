...
<header class="header">
    <div class="header__container">
        <nav class="header__nav">
            ...
            <a href="#main" class="header__link">Новости</a>
            <a href="#main" class="header__link">Тестирование</a>
            <a href="${pageContext.request.contextPath}/sign-out" class="header__link">Выйти</a>
        </nav>
