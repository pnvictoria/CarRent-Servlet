...
<div class="wrapper">
    ...
    <section class="body">
        <form action="${pageContext.request.contextPath}/admin/level/update/post" method="POST" class="form sign-in">
            <div class="form__name item">
                <label for="id"><span>ID</span></label>
                <input class="form__input big" value="${level.getId()}" type="text" id="id" name="id" required>
            </div>
            <div class="form__name item">
                <label for="name"><span>Имя</span></label>
                <input class="form__input big" value="${level.getName()}" type="text" id="name" name="name" required>
            </div>
